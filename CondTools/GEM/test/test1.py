...
sourceConnection = 'oracle://cms_omds_lb/CMS_GEM_MUON_VIEW'
...
CondDB = cms.PSet(
    DBParameters = cms.PSet(
        ...
        security = cms.untracked.string('/afs/cern.ch/cms/DB/conddb'),
        messageLevel = cms.untracked.int32(0),
    ),
    connect = cms.string('oracle://cms_omds_adg/CMS_COND_GENERAL_R'), 
)
...
process.popConRunInfo = cms.EDAnalyzer( "GEMEMapDBWriter"
                                      , SinceAppendMode = cms.bool( True )
                                      , record = cms.string( 'RunInfoRcd' )
                                      #, Source = cms.PSet( OMDSDBConnection
                                      , Source = cms.PSet( CondDB
