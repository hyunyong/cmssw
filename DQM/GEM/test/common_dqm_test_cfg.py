...
process.source = cms.Source("PoolSource",
  fileNames = cms.untracked.vstring(
    ...
    #'file:/eos/cms/store/user/hyunyong/Commissioning2018/run310292/gem_EDM.root'
    'file:/afs/cern.ch/user/h/hyunyong/newCondFormats/src/DQM/GEM/test/gem_EDM.root'
  ),
